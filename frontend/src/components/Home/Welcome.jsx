    ...
    return (
        <MainPadding>
            <div className='flex items-center gap-5 min-h-[500px]'>
                <div className='flex flex-col gap-5 items-end w-[70%]'>
                    <div className=' grid grid-cols-2  gap-5 w-[90%]'>
                        <img src={img1} alt="" className='h-[250px] object-cover' />
                        <img src={img1} alt="" className='h-[250px] object-cover' />
                    </div>
                    <div className='bg-[#FDDDAA] h-[500px] w-full text-foreground/85 p-10 flex flex-col gap-5 font-medium'>
                        
                        <h1 className='text-5xl font-cinzel'>WELCOME TO OUR <br /> CHURCH</h1>
                        ...
                        <Button className="flex gap-2 items-center px-6 mt-6 w-fit">Learn More About Our Values <ArrowRight /> </Button>
                    </div>
                </div>
                <div className='h-[640px] w-[30%]'>
