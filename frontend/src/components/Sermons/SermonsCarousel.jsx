    ...
    <MainPadding className={`pr-0`}>
      <div className="flex gap-20 flex-col md:flex-row">
        <div className="flex flex-col gap-5 md:w-[300px] w-full text-wrap">
          ...
          <HeadingText className="text-foreground md:text-4xl text-3xl font-cinzel">
            {heading}
          </HeadingText>
          {button && (
            <Button
              ...
              className="text-foreground border-foreground gap-2 bg-background hover:bg-background w-fit px-6 hidden md:flex"
            >
              See more <ArrowRight />
            </Button>
          )}
        ...
        <div className="flex flex-grow flex-col gap-6 overflow-hidden">
          <div
            ref={sermonsRef}
            className="flex overflow-hidden overflow-x-scroll gap-10 hide-scrollbar pr-3"
          >
          ...
          {button && (
            <Button
              variant="outline"
              onClick={() => navigate(button)}
              className="text-foreground border-foreground bg-background hover:bg-background w-fit px-6 self-center md:hidden"
            >
              See more <ArrowRight />
            </Button>
          )}
